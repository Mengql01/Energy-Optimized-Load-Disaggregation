...
class SaveDataCallback(BaseCallback):
    def __init__(self, check_interval=100, save_dir="./training_data_(DAY1,45%))", verbose=0):
    ...
    def _save_to_csv(self):
        filename = f"(DAY1,45%))_{self.num_timesteps}.csv"
...
if __name__ == '__main__':
    ...
    model.learn(total_timesteps=500000, callback=callback, tb_log_name="(DAY1,45%))")